...
import nst.app.helper.EAndMAgencyLicenseHelper;
...
import nst.app.manager.EAndMAgencyLicenseManager;
...
@Component
@Transactional
public class EAndMAgencyLicenseService extends
    CEIBaseService<EAndMAgencyLicense, EAndMAgencyLicenseDTO> {

  @Autowired
  EAndMAgencyLicenseManager manager;

  @Autowired
  EAndMAgencyLicenseHelper helper;
  @Autowired
  ...
  public List<EAndMAgencyLicenseDTO> getMyApps() {
    return helper.fromModel(manager.getMyApps());
  }

  @Override
  public BaseManager<EAndMAgencyLicense> getManager() {
    return manager;
  }

  @Override
  public BaseHelper<EAndMAgencyLicense, EAndMAgencyLicenseDTO> getHelper() {
    return helper;
  }

  public ApplicationType applicationType() {
    return ApplicationType.EMAL;
  }

  @Override
  public EAndMAgencyLicenseDTO create() {
  ...
  public void deleteAgencyLegalStatusDetails(Long id, Long legalStatusId) {
    EAndMAgencyLicense form = manager.findForm(id);
