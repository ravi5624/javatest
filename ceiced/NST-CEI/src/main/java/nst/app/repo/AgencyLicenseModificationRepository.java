...
@Repository
public interface AgencyLicenseModificationRepository extends
    CEIBaseRepository<AgencyLicenseModification> {
  ...
  List<AgencyLicenseModification> findMyApps(long userId);
}