...
@RestController
@RequestMapping("api/EAndMAgencyLicense")
public class EAndMAgencyLicenseController extends
    CEIBaseController<EAndMAgencyLicense, EAndMAgencyLicenseDTO> {

  @Autowired
  EAndMAgencyLicenseService service;

  public EAndMAgencyLicenseController() {
    super(EAndMAgencyLicenseDTO.class);
  }

  public CEIBaseService<EAndMAgencyLicense, EAndMAgencyLicenseDTO> getService() {
    return service;
  }
  ...
  public BaseResponse getOccupancyRights() {
   ...
   public BaseResponse vehiclePosessions() {
    ...
    @RequestMapping(value = "/agencyOrganizationTypes", method = RequestMethod.GET)
    public BaseResponse agencyOrganizationTypes(){
      return BaseResponse.createSuccess(LookupUtil.agencyOrganizationType());
    }
}