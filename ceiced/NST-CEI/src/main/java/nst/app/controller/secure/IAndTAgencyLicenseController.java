...
@RestController
@RequestMapping("api/IAndTAgencyLicense")
public class IAndTAgencyLicenseController extends
    CEIBaseController<IAndTAgencyLicense, IAndTAgencyLicenseDTO> {

  @Autowired
  IAndTAgencyLicenseService service;

  public IAndTAgencyLicenseController() {
    super(IAndTAgencyLicenseDTO.class);
  }

  public CEIBaseService<IAndTAgencyLicense, IAndTAgencyLicenseDTO> getService() {
    return service;
  }
