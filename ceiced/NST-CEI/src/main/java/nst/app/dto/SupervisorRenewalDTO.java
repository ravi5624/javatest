...
@Data
@NoArgsConstructor
public class SupervisorRenewalDTO extends BaseModelDTO {
  ...
  public static void main(String[] args) {
    SupervisorRenewalDTO portalUserDTO = new SupervisorRenewalDTO();
    portalUserDTO.setPermitNo("G/AHD/SG/0001/01/1000");
